...
echo "NVHPC sidecar compilers enabled from $NVHPC_ROOT"
echo "CUDA toolkits remain opt-in; source nvhpc-sidecar-cuda11.8.sh or nvhpc-sidecar-cuda12.6.sh as needed."
